      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Premium construction and property solutions built on a foundation
              of trust, quality, and integrity.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                "Home Refurbishments & Renovations",
                "Property Maintenance Services",
                "Roofing & Exterior Solutions",
                "Landscaping & Outdoor Living",
                "Shop Remodelling",
                "Complete Building & Construction Works",
              ].map((item) => (
                <li key={item}>
                  <a
                    href="#services"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-gray-400">
                ...
                <span>
                  Flat 386 Yorktown Road, College Town
                  <br />
                  Sandhurst, England, GU47 0PU
                </span>
              </li>
              <li className="flex items-center gap-3 text-gray-400">
                <Phone className="w-5 h-5 text-primary shrink-0" />
                <a
                  href="tel:07479844578"
              ...
              <li className="flex items-center gap-3 text-gray-400">
                ...
                <a
                  href="mailto:devdconstruction22@gmail.com"
                  className="hover:text-primary transition-colors"
                >
                  devdconstruction22@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Dev & D Construction Company LTD. All
            rights reserved.
          </p>
